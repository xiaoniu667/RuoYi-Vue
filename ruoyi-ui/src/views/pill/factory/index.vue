<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="factoryList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="厂家名称" align="center" prop="factoryName" style="min-width: 200px"/>
      ...
      <el-table-column label="创建时间" align="center" prop="createTime" style="min-width: 150px"/>
